...
<p>
Thank you for your order of <?=$getrecord->course_name?>
              ...
              <tbody>
                 ...
                 <tr style="border-bottom:1px solid #aeaeae">
                    <td style="color:#555555;font-weight:bold;text-align:left;border-right:1px solid #aeaeae;font-weight:normal">
                       <span style="font-weight:bold"><?=$getrecord->course_name?></span>
                                <br >
                       Start Date : <?=date('d-m-Y', strtotime($getrecord->start_date))?><br >
                       End Date : <?=date('d-m-Y', strtotime($getrecord->end_date))?><br >
