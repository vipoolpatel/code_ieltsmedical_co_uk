...
?>
				...
				<div class="container">
				 <form action="<?=base_url()?>home/book_license_key" method="post">

                  <input type="hidden" value="<?=$license_key_id?>" name="license_key_id">

					<div class="row">

                     <div class="col-lg-8  col-md-12">
                     	<div class="cart-title mt-50">
                            <h2>Buy Licence Key </h2>
                        </div><br>
...
<input type="hidden" value="<?=$book->price;?>" id="getTotal">

						<div class="cart-summary">
	                        <h5>Total</h5>
                            <ul class="summary-table">
                               <li><span>subtotal:</span> <span>&pound;<?=$book->price;?></span></li>
                                <li><span>delivery:</span> <span id="getDelivery">Free</span></li>
                                <li><span>total:</span> <span id="getFinalTotal">&pound;<?=$book->price;?></span></li>
                            </ul>
                          <br>
...
$('#ChangeCountry').change(function(){
    ...
    {
        $('#getDelivery').html('&pound;9.95');
        var final_total = parseFloat(total) + 9.95;
