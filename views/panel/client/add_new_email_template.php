...
?>
                ...
                <div class="page-title">
                    <h2><span class="fa fa-arrow-circle-o-left"></span> Create Email Template</h2>
                </div>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-xs-12">
                                                <div class="">
                                                    <input name="subject" required  type="text" placeholder="Subject" class="form-control" />
                                                </div>
                                            </div>
                                        </div>
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-xs-12">
                                                <div class="">
                                                     <textarea rows="25" name="html" required   class="form-control" ></textarea>
                                                </div>
                                            </div>
                                        </div>
