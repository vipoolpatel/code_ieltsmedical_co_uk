...
?>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-xs-12">
                                                <div class="">
                                                    <input name="id" type="hidden" value="<?=$tutor->user_id?>" />
                                                    <input name="name" required  type="text" placeholder="Name" class="form-control" value="<?=set_value('name', $tutor->account_name);?>" />
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            <label class="col-md-3 col-xs-12 control-label">Role <span style="color: #ff0000">*</span></label>
                                            <div class="col-md-6 col-xs-12">
                                                <div class="">
                                                    <select name="role" class="form-control">
                                                        <option <?=($tutor->role == '1') ? 'selected' : ''?> value="1">Admin</option>
                                                        <option <?=($tutor->role == '0') ? 'selected' : ''?> value="0">Sub Admin</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-6 col-xs-12">
                                                <div class="">
                                                    <select name="user_status" class="form-control">
                                                        <option <?=($tutor->user_status == '1') ? 'selected' : ''?> value="1">Active</option>
                                                        <option <?=($tutor->user_status == '0') ? 'selected' : ''?> value="0">Inactive</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
    ...
    <option <?=($tutor->type == 'Nurses') ? 'selected' : ''?> value="Nurses">Nurses</option>
     <option <?=($tutor->type == 'Doctors') ? 'selected' : ''?> value="Doctors">Doctors</option>
