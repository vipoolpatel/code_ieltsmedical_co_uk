        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <div class="page-title">                    
                    <h2><span class="fa fa-arrow-circle-o-left"></span> Create Course Date</h2>
                </div>                                              
                            ...
                            <form class="form-horizontal" id="add_app" method="post" action="" enctype="multipart/form-data"> 
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">Create Course Date</h3>
                                    </div>
                                    ...
                                    <div class="panel-body">  
                                         ...
                                         <label class="col-md-3 col-xs-12 control-label">Course Main Name <span style="color: red;"> *</span></label>
                                   ...
                                   <div class="form-group">
                                      ...
                                      <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-xs-12">                                            
                                                <div class="">
                                                    <input name="start_date"  type="text" placeholder="Start Date" class="form-control datepicker" value="<?= set_value('start_date'); ?>" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-xs-12">                                            
                                                <div class="">
                                                    <input name="end_date"  type="text" placeholder="End Date" class="form-control datepicker" value="<?= set_value('end_date'); ?>" />
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-xs-12">                                            
                                                <div class="">
                                                    <textarea name="decription" rows="5" type="text" placeholder="Description" class="form-control" value="<?= set_value('decription'); ?>" /></textarea> 
